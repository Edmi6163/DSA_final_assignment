...
void test_search_char_skip_list()
{
  ...
  TEST_ASSERT_EQUAL_INT(0,compare_string(search_skip_list(list,to_search+0),actual+0));
  TEST_ASSERT_NULL(search_skip_list(list,to_search +1));
  TEST_ASSERT_EQUAL_INT(0,compare_string(search_skip_list(list,to_search+2),actual+2));
  TEST_ASSERT_EQUAL_INT(0,compare_string(search_skip_list(list,to_search+4),actual+4));
}
