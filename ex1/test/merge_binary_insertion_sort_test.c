...
void test_int_array_with_k_six(void) {
  ...
  merge_binary_insertion_sort(actual, 5, sizeof(actual[0]), 6,
                              compare_int_test);
...
void test_string_array_with_key_six(void) {
  ...
  merge_binary_insertion_sort(actual, 6, sizeof(char *), 6,
                              compare_string_test);
...
void test_int_array_with_k_one(void) {
  static int actual[] = {8, 9, 78, 653, 5};
  static int expected[] = {5, 8, 9, 78, 653};
  merge_binary_insertion_sort(actual, 5, sizeof(actual[0]), 1,
                              compare_int_test);
  TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, 5);
}
...
void test_string_array_with_key_one(void) {
  ...
  static char *actual[] = {a, b, c, d, e, f};
  static char *expected[] = {a, e, f, d, c, b};
  merge_binary_insertion_sort(actual, 6, sizeof(actual[0]), 1,
                              compare_string_test);
  TEST_ASSERT_EQUAL_STRING_ARRAY(expected, actual, 5);
}
...
void test_negative_int_array_with_k_one(void) {
  static int actual[] = {-8, -9, -78, -653, -5};
  static int expected[] = {-653, -78, -9, -8, -5};
  merge_binary_insertion_sort(actual, 5, sizeof(actual[0]), 1,
                              compare_int_test);
  TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, 5);
}
...
int main() {
  ...
  RUN_TEST(test_negative_int_array_with_k_one);
  return UNITY_END();
}
